...
function createQuestionList(i){
    ...
    let questionCol = $(`<div class="col">${questionData[i].quest}</div>`);
    let option1Col = $(`<div class="col">${questionData[i].opt1}</div>`);
    let option2Col = $(`<div class="col">${questionData[i].opt2}</div>`);
    let option3Col = $(`<div class="col">${questionData[i].opt3}</div>`);
    let option4Col = $(`<div class="col">${questionData[i].opt4}</div>`);
