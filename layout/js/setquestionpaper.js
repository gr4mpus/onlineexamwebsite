...
$(document).ready(function() {
        ...
        addBtn = $('#add-btn');
        /*let option1Radio = $('#option1-radio').checked;
        /!*let option2Radio = $('#option2-radio').checked;*!/
        let option3Radio = $('#option3-radio').checked;
        let option4Radio = $('#option4-radio').checked;*/
        ...
        addBtn.click(function () {
            ...
            /*console.log(option1Radio);
            console.log(option2Radio);*/
